...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Agu 2019 pada 05.43
...
INSERT INTO `barang_aset_pinjam` (`kode_pinjam`, `id_aset_pinjam`, `kode_aset`, `seri`, `nama_pegawai`, `keterangan`, `jabatan`, `tanggal_pinjam`, `kartu_p`) VALUES
('PJM001', 6, '3.02.01.01.003', '001', 'dany', '-', 'staf keum', '26 July 2019', '1'),
('PJM007', 7, '3.02.01.04.001', '001', 'sony', '-', 'staf keum', '26 July 2019', '2'),
('PJM008', 8, '3.02.01.04.001', '002', 'zae', 'basemen', 'staf keum', '26 July 2019', '3');
...
INSERT INTO `barang_aset_sub` (`id_aset_sub`, `tanggal_input`, `tahun`, `seri`, `nama_aset`, `detail_aset`, `merk_aset`, `penguasaan`, `keterangan`, `gambar`, `satuan_aset`) VALUES
(3, '25 July 2019', '2015', '001', 'Sepeda Motor', '', 'Suzuki', 'milik sendiri', '-', '', 'Unit'),
(4, '25 July 2019', '2015', '001', 'Station Wagon', '', 'Honda', 'milik sendiri', '-', '', 'Unit'),
(5, '25 July 2019', '2016', '002', 'Sepeda Motor', '', 'Honda', '', '', '', 'Unit');
...
--
ALTER TABLE `barang_aset_pinjam`
  MODIFY `id_aset_pinjam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `barang_aset_sub`
  MODIFY `id_aset_sub` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
