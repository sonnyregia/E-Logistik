...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2019 at 06:37 PM
...
(1, '', '0000-00-00', 10, 4, 6, '18129.916666667', '');
...
INSERT INTO `barang_aset_pinjam` (`kode_pinjam`, `id_aset_pinjam`, `id_aset`, `id_aset_sub`, `nama_pegawai`, `keterangan`, `jabatan`, `tanggal_pinjam`, `kartu_p`, `seri`) VALUES
('', 10, 4, 6, 'caca', '-', 'Staf Keum', '2019-08-22', '1', '');
...
--
ALTER TABLE `barang_aset_pinjam`
  MODIFY `id_aset_pinjam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
